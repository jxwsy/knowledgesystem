...
注1：griffin 官网 doc 部分教程内容较少，可以参考 griffin 源文件的 `griffin-doc/` 目录下的文件和 [wiki](https://cwiki.apache.org/confluence/display/GRIFFIN/)。
...
进入 启动 es 后，在 es 里创建 griffin 索引，并查看
...
....
streaming_accu [1640595260000] metrics: 
{"name":"streaming_accu","tmst":1640595260000,"value":{"matched_count":7,"matchedFraction":0.7,"total_count":10,"miss_count":3},"applicationId":"application_1640773388037_0003"}
streaming_accu [1640774500000] metrics: 
{"name":"streaming_accu","tmst":1640774500000,"value":{"matched_count":5,"matchedFraction":0.5,"total_count":10,"miss_count":5},"applicationId":"application_1640773388037_0003"}
....
```
...
```sh
[root@bigdata101 griffin-0.5.0]# hadoop fs -cat /griffin/persist/streaming_accu/1640774500000/_METRICS
21/12/29 18:46:42 WARN util.NativeCodeLoader: Unable to load native-hadoop library for your platform... using builtin-java classes where applicable
{"name":"streaming_accu","tmst":1640774500000,"value":{"matched_count":5,"matchedFraction":0.5,"total_count":10,"miss_count":5},"applicationId":"application_1640773388037_0003"}

[root@bigdata101 griffin-0.5.0]# hadoop fs -cat /griffin/persist/streaming_accu/1640774500000/missRecords
21/12/29 18:47:21 WARN util.NativeCodeLoader: Unable to load native-hadoop library for your platform... using builtin-java classes where applicable
{"name":"Apple","__tmst":1640774500000,"color":"yellow","id":1,"time":"2021-12-29_18:41:05"}
{"name":"Cherry","__tmst":1640774500000,"color":"yellow","id":3,"time":"2021-12-29_18:41:05"}
{"name":"Durian","__tmst":1640774500000,"color":"red","id":4,"time":"2021-12-29_18:41:05"}
{"name":"Papaya","__tmst":1640774500000,"color":"red","id":7,"time":"2021-12-29_18:41:05"}
{"name":"Pitaya","__tmst":1640774500000,"color":"yellow","id":10,"time":"2021-12-29_18:41:05"}
```
...
把 `hadoop-lzo-0.4.21-SNAPSHOT.jar` 文件复制到 spark 的 `jars/` 目录中。
